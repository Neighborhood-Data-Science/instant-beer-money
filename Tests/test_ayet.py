...
class TestBaselineAYET:
    ...
    """
    def test_access_ayet_offerwall(self,setup_raw_ayet_page):
        """
        Tests if able to successfully open Ayet Offerwall
        """
        assert setup_raw_ayet_page.current_url == os.environ['MASTER_AYET']


    def test_parsed_offer_info_is_dict(self,setup_raw_ayet_page):
        """
        Tests if output of function is an expected dictionary.
        """
        offer_dict = ayet_info.parse_available_offer_information(setup_raw_ayet_page)
        assert isinstance(offer_dict, dict)


    def test_parsed_offer_info_is_equal(self,setup_raw_ayet_page):
        """
    ...
    def test_parsed_offer_info_dict_size(self,setup_raw_ayet_page,size=5):
        """
    ...
    def test_parsed_dataframe_is_dataframe(self,setup_raw_ayet_page):
        """
    ...
    def test_values_in_multiple_rewards(self,setup_raw_ayet_page):
        """
    ...
    def test_values_in_devices(self,setup_raw_ayet_page):
        """
...
class TestMainUserAYET:
    ...
    """
    def test_access_offerwall_main_user(self,setup_main_user_ayet_page):
        """
        Tests if able to successfully open ayet Offerwall
        """
        assert setup_main_user_ayet_page.current_url == os.environ['AYET']


    def test_parsed_completed_offer_info_is_dict(self,setup_main_user_ayet_page):
        """
        Tests if output of function is an expected dictionary.
        """
        completed_offer_dict = ayet_info.parse_completed_offer_info(setup_main_user_ayet_page)
        assert isinstance(completed_offer_dict, dict)


    def test_parsed_completed_offer_info_dict_size(self, setup_main_user_ayet_page, size=3):
        """
    ...
    def test_parsed_completed_offer_info_is_equal(self, setup_main_user_ayet_page):
        """
    ...
    def test_completed_dataframe_is_dataframe(self, setup_main_user_ayet_page):
        """
        Tests if resultant dataframe is type dataframe.
        """
        completed_offer_dict = ayet_info.parse_completed_offer_info(setup_main_user_ayet_page)
        completed_offer_dataframe = ayet_info.create_completed_offer_dataframe(completed_offer_dict)
        assert isinstance(completed_offer_dataframe, pd.DataFrame)


    def test_parsed_pending_offer_info_is_dict(self, setup_main_user_ayet_page):
        """
        Tests if output of function is an expected dictionary.
        """
        pending_offer_dict = ayet_info.parse_pending_offer_info(setup_main_user_ayet_page)
        assert isinstance(pending_offer_dict, dict)


    def test_parsed_pending_offer_info_dict_size(self, setup_main_user_ayet_page, size=3):
        """
    ...
    def test_parsed_pending_offer_info_is_equal(self, setup_main_user_ayet_page):
        """
    ...
    def test_pending_dataframe_is_dataframe(self, setup_main_user_ayet_page):
        """
        Tests if resultant dataframe is type dataframe.
        """
        pending_offer_dict = ayet_info.parse_pending_offer_info(setup_main_user_ayet_page)
        pending_offer_dataframe = ayet_info.create_pending_offer_dataframe(pending_offer_dict)
